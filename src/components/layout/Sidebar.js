        ...
        <div className="container sideBar-container d-flex flex-column align-items-center">
          <ul className="list-unstyled">
            <li className="mb-4">
              <Link
                to="/dashboard"
                className={`text-light text-decoration-none dash-link ${
            ...
            <li className="mb-4">
              <Link
                to="/confirmations"
                className={`text-decoration-none text-light dash-link ${
                  activePage === "confirmations" ? "active" : ""
                }`}
              >
                <FontAwesomeIcon icon={faCheck} className="text-light mx-1" />
                Confirmation
              </Link>
            </li>
